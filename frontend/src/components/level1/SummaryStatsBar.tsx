...
export function SummaryStatsBar() {
  ...
  return (
    <div className="grid grid-cols-5 gap-3 border-t border-[var(--border)] bg-[var(--surface)] px-4 py-3 text-sm">
      <div className="rounded-xl bg-[var(--surface-raised)] px-3 py-2">
